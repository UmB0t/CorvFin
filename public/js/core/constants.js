...
window.ICONS = {
  ...
  fullscreen: `<svg class="svg-icon" viewBox="0 0 24 24"><path d="M8 3H5a2 2 0 0 0-2 2v3m18-5h-3a2 2 0 0 0-2 2v3M3 16v3a2 2 0 0 2 2h3m13 0h3a2 2 0 0 2 2-2v-3"/></svg>`
};
